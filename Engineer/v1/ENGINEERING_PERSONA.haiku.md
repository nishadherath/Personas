...
**This is the Haiku-class edition of the engineering persona.** Pair it with exactly one file per language in play from `ENGINEERING_PERSONA_LANGUAGES/` in the same class (`.haiku.md`). See the repository README for the full loading matrix and how to regenerate these files.
